...
from job_app.views import MainView, VacanciesView, CompanyView, SpecializedVacanciesView, \
    ...
    ResumeLetsStartView, ResumeDeleteView, CompanyDeleteView, CompanyVacancyDeleteView
...
urlpatterns = [
    ...
    path('mycompany/delete/', login_required(CompanyDeleteView.as_view()), name='company_delete'),
    path('mycompany/vacancies/', login_required(CompanyVacanciesView.as_view()), name='company_vacancies'),
    path('mycompany/vacancies/create', login_required(CompanyVacancyCreateView.as_view()),
         name='company_vacancy_create'),
    path('mycompany/vacancies/<int:pk>/', login_required(CompanyVacancyEditView.as_view()),
         name='company_vacancy_edit'),
    path('mycompany/vacancies/<int:pk>/delete/', login_required(CompanyVacancyDeleteView.as_view()),
         name='company_vacancy_delete'),
    path('myresume/letsstart/', login_required(ResumeLetsStartView.as_view()), name='resume_letsstart'),
    ...
    path('myresume/delete/', login_required(ResumeDeleteView.as_view()), name='resume_delete'),
