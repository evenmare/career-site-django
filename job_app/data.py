...
jobs = ["Разработчик на Python", "Разработчик в проект на Django", "Middle SWIFT-разработчик",
        "Мидл программист на Python", "Грамотный питон разработчик"]

skills = ["Python", "Nginx", "Git", "Django", "Docker", "Kubernetes", "Высоконагруженные системы",
          "PostgreSQL", "Swift", "CoreData", "Git", "ООП", "Базы данных", "MySQL"]
